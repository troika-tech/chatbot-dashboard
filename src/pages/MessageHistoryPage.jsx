...
import { Mail, Eye, Clock, User, ChevronDown, Filter, X } from "lucide-react";
                ...
                {chatHistory.map((msg, idx) => (
                  <div
                    ...
                    className={`max-w-[80%] rounded-2xl p-4 text-sm shadow-sm ${
                      msg.sender === "user"
                        ? "ml-auto bg-[#4f46e5] text-white rounded-tr-none" // Bot message (you)
                        : "bg-indigo-50 text-gray-800 rounded-tl-none" // User message
                    }`}
                  >
